...
const Header = () => {
  return (
    <div className='flex flex-col md:flex-row flex-wrap bg-primary rounded-lg px-6 md:px-10 lg:px-20 '>
      {/*-----------left side----------- */}
      <div className='md:w-1/2 flex flex-col items-start justify gap-4 py-10 m-auto md:py-[10vw] md:mb-[-30vpx]'>
     ...
     <div className='flex flex-colmd:flex-row items-center gap-3 text-white text-small font-light'>
